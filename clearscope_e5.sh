...
weight_decays=(0.01 0.001 0.0001)  # weight_decay 参数的不同取值
weight_decay_fs=(0.01 0.001 0.0001 0.00005)  # weight_decay_f 参数的不同取值
num_heads=(2 4 8)                         # num_heads 参数的不同取值
max_epoch_fs=(20 50 70)               # max_epoch_f 参数的不同取值
...
data_path="clearscope_e5_merge_edge_data.pt"
ground_truth_path="../Ground_Truth/ground_truth_nids_clearscope_e5.pt"
gpu_ids=(1 1 1)
counter=0
# 循环遍历所有参数组合 
for seed in "${seeds[@]}"
                            ...
                            do
                              ...
                              # 运行 Python 脚本，替换对应的参数
                                CUDA_VISIBLE_DEVICES=$device python main_transductive.py \
                                  ...
                                  >> tmp_tmp_clearscope_e5_$device.log & \
