                        ...
                        do
                          ...
                          do
                            ...
                            do
                              ...
                              CUDA_VISIBLE_DEVICES=$device python distribution.py \
                                --device 0 \
                                --dataset $dataset \
                                --mask_rate $mask_rate \
                                --encoder "gatedge" \
