...
if __name__ == '__main__':
    ...
    for file in os.listdir('mimicry_study'):
        # if file.endswith('data.pt'):  
        filename = os.path.join('mimicry_study', file) 
        data = 'cadets_e3_merge_edge_data_mimicry_3000_edge.pt'
        ground_truth = '../Ground_Truth/ground_truth_cadet_v2.pt'
        print('============================Processing file:=====================\n', filename)
        method_12_revised(filename,data, ground_truth)
