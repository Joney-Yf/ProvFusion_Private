...
weight_decay_fs=(5e-5 2e-6)  # weight_decay 参数的不同取值
...
dataset="THEIA_E5"
data_path="theia_e5_merge_edge_data_final.pt"
ground_truth_path="../Ground_Truth/ground_truth_nids_theia_e5.pt"
gpu_ids=(1 1)
counter=0
# 循环遍历所有参数组合
for seed in "${seeds[@]}"
